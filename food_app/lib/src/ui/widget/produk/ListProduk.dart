...
class ListProduk extends StatefulWidget {
  late String nama_produk, harga, gambar, id_pelanggan;
  late bool isFavorite, isLogin;
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.shopping_basket,
                    size: 18.0, color: Color(0xFFD17E50)),
                SizedBox(
                  width: 10.0,
                ),
                Text(
      ...
      return Row(
        ...
        children: [
          ...
          Text(
            '${numQty.toString()}',
            style: TextStyle(
                color: Color(0xFFD17E50), fontFamily: 'Varela', fontSize: 14.0),
          ),
          InkWell(
            onTap: () {
              setState(() {
          ...
          InkWell(
              ...
              child: Icon(Icons.check, color: Colors.green[600], size: 20.0)),
          InkWell(
              onTap: () {
                setState(() {
                  add = false;
              ...
              child: Icon(Icons.close, color: Colors.red[600], size: 20.0))
        ],
      );
    }
  }
