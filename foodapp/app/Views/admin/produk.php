...
<script>
    let urlList = "<?= site_url('produk/ajaxList'); ?>";
    let urlSave = "<?= site_url('produk/ajaxSave'); ?>";
    let urlEdit = "<?= site_url('produk/ajaxEdit/'); ?>";
    let urlUpdate = "<?= site_url('produk/ajaxUpdate'); ?>";
    let urlDelete = "<?= site_url('produk/ajaxDelete/'); ?>";
    let urlImg = "<?= base_url('/uploads/img'); ?>/";
    let urlImgDefault = "<?= base_url('assets/images/default.png'); ?>";

    let urlStatus = "<?= site_url('produk/ajaxStatus/'); ?>";
</script>
                        ...
                        <table id="mytable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">Desikripsi</th>
