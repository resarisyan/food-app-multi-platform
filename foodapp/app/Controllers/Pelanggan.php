...
{
    protected $halaman, $title, $pelanggan;
    ...
    public function ajaxList()
    {
        ...
        foreach ($list as $temp) {
            ...
            $status = '
            <div class="text-center">
                <a href="javascript:void(0)" data-toggle="tooltip" title="' . ($temp['status_pelanggan'] == 0  ? 'Aktifkan' : 'Nonaktifkan') . '" onclick="ajaxStatus(' . $temp["id"] . ')">
